const NavigationSidebar = (active) => {
    return(`
            ...
            <a class="list-group-item ${active === 'home'? 'active':''}" href="../ExploreScreen/explore.html">
                <div class="row">
            ...
            <a class="list-group-item ${active === 'explore'? 'active':''}" href="../../build/ExploreScreen/explore.html">
                <div class="row">
